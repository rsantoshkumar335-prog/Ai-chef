...
const materialThemes = {
    // --- Existing Themes ---
    default: {
        light: { '--primary': '#6750A4', '--primary-container': '#EADDFF', '--secondary': '#625B71', '--background': '#FFFBF0', '--surface': '#FFFBF0', '--text-main': '#1C1B1F' },
        dark: { '--primary': '#D0BCFF', '--primary-container': '#4F378B', '--secondary': '#CCC2DC', '--background': '#1C1B1F', '--surface': '#1C1B1F', '--text-main': '#E6E1E5' }
    },
    warm: {
        light: { '--primary': '#C4314B', '--primary-container': '#FFD9E2', '--secondary': '#775652', '--background': '#FFFBF0', '--surface': '#FFFBF0', '--text-main': '#201A1B' },
        dark: { '--primary': '#FFB1C8', '--primary-container': '#8C3249', '--secondary': '#E7BDB6', '--background': '#201A1B', '--surface': '#201A1B', '--text-main': '#ECE0E0' }
    },
    green: {
        light: { '--primary': '#006E26', '--primary-container': '#97F991', '--secondary': '#526350', '--background': '#FFFBF0', '--surface': '#FFFBF0', '--text-main': '#1A1C19' },
        dark: { '--primary': '#7BDC76', '--primary-container': '#005313', '--secondary': '#B8CCB5', '--background': '#1A1C19', '--surface': '#1A1C19', '--text-main': '#E2E3DD' }
    },
    orange: {
        light: { '--primary': '#825500', '--primary-container': '#FFDDB3', '--secondary': '#6F5B40', '--background': '#FFFBF0', '--surface': '#FFFBF0', '--text-main': '#1F1B16' },
    ...
    ocean: {
        light: { '--primary': '#006684', '--primary-container': '#BFE8FF', '--secondary': '#4C616C', '--background': '#FFFBF0', '--surface': '#FFFBF0', '--text-main': '#191C1E' },
    ...
    india: {
        light: { '--primary': '#FF9933', '--primary-container': '#FFE5CC', '--secondary': '#138808', '--background': '#FFFBF0', '--surface': '#FFFBF0', '--text-main': '#000080' },
    ...
    midnight: {
        light: { '--primary': '#5856D6', '--primary-container': '#E7E7FF', '--secondary': '#FFC107', '--background': '#FFFBF0', '--surface': '#FFFBF0', '--text-main': '#1C1C1E' },
